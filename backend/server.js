...
// schema definition for our grapql server
const typeDefs = `
    type Blog {
        id: ID!
        content: String!
...
// registering our type definitions and resolver for schema that we need to
...
(async function () {
  // starting the apollo server to expose endpoint to client
